...
namespace IBS.DataAccess.Migrations
{
    ...
    [Migration("20260717033738_AddMsapPostedPeriod")]
    partial class AddMsapPostedPeriod
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IBS.Models.MSAP.Billing", b =>
                {
                    ...
                    b.Property<string>("UnpostRemarks")
                        .HasColumnType("text")
                        .HasColumnName("unpost_remarks");
                    ...
                    b.HasIndex("Year", "MsapBillingNumber", "Company")
                        .IsUnique()
                        .HasDatabaseName("ix_msap_billings_billing_year_number_company");
            ...
            modelBuilder.Entity("IBS.Models.MSAP.MasterFile.UserAccess", b =>
                {
                    ...
                    b.Property<bool>("CanReverseBilling")
                        .HasColumnType("boolean")
                        .HasColumnName("can_reverse_billing");
            ...
            modelBuilder.Entity("IBS.Models.MSAP.VesselSchedule", b =>
                {
                    b.Property<int>("VesselScheduleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("vessel_schedule_id");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("VesselScheduleId"));

                    b.Property<string>("AssignedTugboatIds")
                        .HasColumnType("text")
                        .HasColumnName("assigned_tugboat_ids");
                    ...
                    b.HasIndex("TerminalId")
                        .HasDatabaseName("ix_msap_vessel_schedules_terminal_id");

                    b.HasIndex("VesselId")
                        .HasDatabaseName("ix_msap_vessel_schedules_vessel_id");

                    b.HasIndex("PortId", "TerminalId")
                        .HasDatabaseName("ix_msap_vessel_schedules_port_id_terminal_id");

                    b.ToTable("msap_vessel_schedules", (string)null);
                });
            ...
            modelBuilder.Entity("IBS.Models.MasterFile.MsapPostedPeriod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_msap_posted_periods");

                    b.HasIndex("Year", "Month")
                        .IsUnique()
                        .HasDatabaseName("ix_msap_posted_periods_year_month");

                    b.ToTable("msap_posted_periods", (string)null);
                });
            ...
            modelBuilder.Entity("IBS.Models.MSAP.VesselSchedule", b =>
                {
                    b.HasOne("IBS.Models.MSAP.JobOrder", "JobOrder")
                        ...
                        .HasForeignKey("JobOrderId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_msap_vessel_schedules_msap_job_orders_job_order_id");
                    ...
                    b.HasOne("IBS.Models.MSAP.MasterFile.Terminal", "Terminal")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_msap_vessel_schedules_msap_terminals_terminal_id");
